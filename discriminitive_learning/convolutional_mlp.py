...
def evaluate_lenet5(learning_rate=0.1, n_epochs=200,
    ...
    layer0_input = x.reshape((batch_size, 3, 27, 27))
    ...
    layer0 = LeNetConvPoolLayer(
        rng,
        input=layer0_input,
        image_shape=(batch_size, 3, 27, 27),
    ...
    while (epoch < n_epochs) and (not done_looping):
        ...
        for minibatch_index in xrange(n_train_batches):
            ...
            if (iter + 1) % validation_frequency == 0:
                ...
                train_error.append(this_train_loss * 100)
                test_error.append(this_test_loss * 100)
    ...
    plt.plot(test_error)
    plt.ylabel('error')
    plt.legend(['train error', 'validation error', 'test error'], loc='upper right')
    plt.show()

 ...
 */
template <typename Dtype>
class CroppingImageDataLayer : public BasePrefetchingDataLayer<Dtype> {
 public:
  explicit CroppingImageDataLayer(const LayerParameter& param)
      : BasePrefetchingDataLayer<Dtype>(param) {}
  virtual ~CroppingImageDataLayer();
  virtual void DataLayerSetUp(const vector<Blob<Dtype>*>& bottom,
      const vector<Blob<Dtype>*>& top);
 ...
 protected:
  ...
  vector<std::tuple<std::string, int, int, int> > lines_4d;
  int lines_id_;
};
